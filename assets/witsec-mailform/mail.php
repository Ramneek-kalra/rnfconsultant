...
$to = "monika@rnfconsultant.com";														// To Address
$toAlt = "";												// Additional Recipients
$from = "monika@rnfconsultant.com";													// From Address
$fromName = "Monika Verma | RnF Consultant";											// From Name
...
$autorespondSubjectPrefix = "Re: Resume Submission | ";			// Autorespond Form Subject Prefix
$autorespondSubject = "";						// Autorespond Custom Subject
$autorespondTemplate = "Hi {name},<br><br>Thank you for your submission. We'll get back to you as soon as we can.<br>Here's the information you sent us:<br><br>{formdata}<br><br>---<br>Monika Verma<br>CEO & Founder, RnF Consultant<br>monika@rnfconsultant.com<br>http://rnfconsultant.com/";					// Autorespond Template
...
$smtpHost = "smtpout.secureserver.net";											// SMTP Host
$smtpPort = "465";											// SMTP Port
$smtpSecure = "ssl";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "monika@rnfconsultant.com";									// SMTP Username
$smtpPassword = "Monika123@123@";									// SMTP Password
